...
export default function (colorStr) {
  ...
  if (themeId === 1) {
    const themeOverrides = {
      main: { back: "#ffdb66", front: "#333333" },    // 品牌黄 (标准色)
      pink_1: { back: "#ff8585", front: "#FFFFFF" },  // 活力珊瑚红 (发送按钮)
      pink_2: { back: "#FFCE54", front: "#333333" },     // [raw] 标签 (正黄色)
      gray_1: { back: "#fff3dd", front: "#000000" },   // 全局背景 (淡米黄) / 文字调至纯黑补偿 + '55'
      gray_2: { back: "#D2D2CA", front: "#333333" },
      gray_3: { back: "#f5f3dc", front: "#2C3E50" },   // 侧边栏 (暖米黄)
      gray_4: { back: "#f5f2e1", front: "#2C3E50" },   // 容器背景 (浅米黄)
      gray_5: { back: "#D9A93A", front: "#FFFFFF" },   // 列表页眉 (金黄)
      gray_6: { back: "#333333", front: "#333333" },
      gray_8: { back: "#FFFFFF", front: "#000000" },   // 气泡主基调 (纯白) / 文本纯黑
      gray_9: { back: "#FBF3DC", front: "#2C3E50" },   // 浅暖白
      gray_12: { back: "#F0E4C8", front: "#333333" },     // 导航栏背景 (米黄)
      brown_1: { back: "#f7f1e0", front: "#333333" },  // 用户气泡背景 (暖白)
      brown_2: { back: "#FBF6E8", front: "#2C3E50" },  // 暖白
      brown_3: { back: "#2C3E50", front: "#FFFFFF" },
      brown_4: { back: "#FFFFFF", front: "#333333" },  // 输入框背景
      brown_5: { back: "#f5f0e0", front: "#333333" },  // 对方气泡背景 (暖白)
      yellow_1: { back: "#FFB300", front: "#333333" },  // 琥珀黄 (回复/引用按钮)
      yellow_2: { back: "#F5C71A", front: "#333333" },    // 气泡侧边金边 (高饱和)
      blue_1: { back: "#FFE9B8", front: "#333333" },   // 浅暖黄 (撤到本条/清除之前)
      blue_2: { back: "#A67C00", front: "#FFFFFF" },   // 深琥珀
      blue_3: { back: "#F7EAD2", front: "#343c47" }, //思考中背景 (暖黄白)
  ...
  if (themeId === 2) {
    const themeOverrides = {
      ...
      gray_2: { back: "#CAD5E2", front: "#333333" },
      ...
      gray_12: { back: "#e6e6e6", front: "#333333" },//导航栏背景
      ...
      blue_3: { back: "#e5e8ee", front: "#343c47" }, //思考中背景
